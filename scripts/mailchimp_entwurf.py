...
# Tag "Studien-Newsletter Longevity" (Tags sind statische Segmente). Die Nummer steht
...
GRUPPE_NAME = "Studien Newsletter Longevity"
...
SEITE = "https://longevity.m-vf.de"   # einfache Zeichenkette: longevity.m-vf.de wird beim
...
# mit startswith(), also wuerde "MVF Studien-Newsletter Longevity ..." drueben als
...
PRAEFIX = "MVF Longevity-Newsletter"
...
@font-face{font-family:'Lato';font-style:normal;font-weight:400;
  src:url('https://longevity.m-vf.de/fonts/lato-400.woff2') format('woff2');}
@font-face{font-family:'Lato';font-style:normal;font-weight:700;
  src:url('https://longevity.m-vf.de/fonts/lato-700.woff2') format('woff2');}
</style>"""
...
def newsletter_html(studien: list[dict], hinweis: str = "") -> str:
    ...
    dl = "https://longevity.m-vf.de/download"
...
<tr><td align="center" style="padding:24px 12px;">
  <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;background:#ffffff;">
    ...
    <tr><td style="background:#ffffff;padding:18px 28px 14px;">
      <a href="https://longevity.m-vf.de/?{p}&amp;utm_content=logo" style="text-decoration:none;">
        <img src="https://longevity.m-vf.de/logo/mvf-logo.png" width="170" height="45"
    ...
    <tr><td style="background:{BLAU};padding:22px 28px;">
      ...
      <p style="margin:4px 0 0;font:bold 24px/1.3 {FONT};color:#ffffff;">
        Neueste Studien - Gesundes Altern und Longevity</p>
    ...
    <tr><td style="padding:24px 28px 4px;">
      <p style="margin:0;font:15px/1.65 {FONT};color:#333;">
        ...
        <a href="https://longevity.m-vf.de/?{p}&amp;utm_content=intro" style="color:{BLAU};font-weight:bold;">Knowledge-Hub</a>.</p>
    </td></tr>
{studienteil(studien)}
    ...
    <tr><td style="padding:26px 28px 0;" align="center">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0">
        <tr><td style="background:{GOLD};">
          <a href="https://longevity.m-vf.de/?{p}&amp;utm_content=cta"
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr><td style="border-top:1px solid #D0D8E4;padding-top:18px;font:12px/1.7 {FONT};color:#777;">
          ...
          <p style="margin:0;">
            ...
            <a href="https://longevity.m-vf.de/#datenschutz" style="color:#777;">Datenschutz</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
...
def schreibe_status(stand: str, titel: str, betreff: str, studien: list[dict],
    ...
    with open(STATUSDATEI, "w", encoding="utf-8") as f:
        json.dump({
            "hub": "Knowledge-Hub Gesundes Altern & Longevity",
...
def main() -> int:
    ...
    t = tage(offen)
    betreff = ("Neueste Studien - Gesundes Altern und Longevity – " +
